            ...
            <div className="bg-white min-h-[20vh] p-4 pt-2 md:px-8 lg:px-16 xl:px-32">
                <div className="max-w-7xl mx-auto">
                    <div className="mt-8 text-left space-y-6">
                        ...
                        <div 
                            className="cursor-pointer hover:shadow-lg transition-shadow duration-300 p-4 rounded-lg"
                            onClick={() => handleNavigation("/service1")}
                        >
                            <h2 className="text-[15px] font-semibold text-[#2E3E65] hover:text-[#2E3E65] transition-colors duration-300 font-poppins">
                                Data & AI Strategy
                            </h2>
