...
const FounderCard = ({ name, image, items, linkedin }) => (
  <div className="w-80 h-[500px] rounded-lg overflow-hidden shadow-lg bg-white hover:shadow-2xl transition-shadow duration-300 relative font-poppins flex flex-col">
    {/* Image */}
    <img 
      src={image} 
      alt={name}
    ...
    <div className="px-4 py-2 flex flex-col flex-grow">
      <div className="flex justify-between items-center mb-9">
        <h2 className="text-[20px] font-bold text-blue-900">{name}</h2>
    ...
    <>
      ...
      <div className="relative w-full">
        ...
        <div className="relative w-full h-60 flex items-center justify-center">
          <h1 className="text-[40px] font-bold text-[#2E3E65] text-center font-poppins">The Team</h1>
        </div>
        {/* Background Pattern */}
